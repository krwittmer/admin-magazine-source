...
New-AzDevCenterAdminProject -ResourceGroupName $resourceGroupDevCenter `
    ...
    -Description "Project for Java Development with internal networking" `
    -Location $location
